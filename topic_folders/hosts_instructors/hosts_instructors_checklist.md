...
* Set up the workshop website using the [workshop template](https://github.com/swcarpentry/workshop-template).  Detailed instructions are in this repo's [README](https://github.com/swcarpentry/workshop-template/blob/gh-pages/README.md).
