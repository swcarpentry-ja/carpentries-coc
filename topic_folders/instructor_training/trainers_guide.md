...
| | | | | | | |
| LC |  | shell       | [Library Carpentry: The Shell Lesson](https://librarycarpentry.github.io/lc-shell/) | [What is the shell?](https://librarycarpentry.github.io/lc-shell/01-intro-shell/)  |      [What is the shell?](https://librarycarpentry.github.io/lc-shell/01-intro-shell/)           has no live coding.                       |
| LC |  | all lessons | TBA | TBA | These lessons are approved for Carpentry teaching demos. We will be adding recommendations regarding start points soon! |
