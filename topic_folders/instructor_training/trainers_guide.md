...
| SWC | | [Programming with R](http://swcarpentry.github.io/r-novice-inflammation/) | <ul><li> [Analyzing Multiple Data Sets](http://swcarpentry.github.io/r-novice-inflammation/03-loops-R/index.html) </li><li> [Loops in R](http://swcarpentry.github.io/r-novice-inflammation/15-supp-loops-in-depth/index.html) </li><li> [Making Choices](http://swcarpentry.github.io/r-novice-inflammation/04-cond/index.html) </li></ul> | <ul><li> [Creating Functions](http://swcarpentry.github.io/r-novice-inflammation/02-func-R/index.html) </li><li> [Best Practices for Writing R Code](http://swcarpentry.github.io/r-novice-inflammation/06-best-practices-R/index.html) </li><li> [Reading and Writing CSV Files](http://swcarpentry.github.io/r-novice-inflammation/11-supp-read-write-csv/index.html) </li></ul> | The episodes to avoid have dependencies. |
...
| | | | | | | |
| DC | Genomics | [Project Organization and Management for Genomics](https://datacarpentry.org/organization-genomics/) | none | **Ok to use any episode.** No live coding, but similar to layout of Ecology spreadsheets lesson. Includes demonstrations with spreadsheet software and with navigating through SRA database through browser. | |
| DC | Genomics | [Introduction to the Command Line for Genomics](https://datacarpentry.org/shell-genomics/) | none | **Ok to use any episode.** If using **episode 1** ([Introducing the Shell](https://datacarpentry.org/shell-genomics/01-introduction/)) for demo, have trainee **start from the `cd shell_data` command.**  | |
| DC | Genomics | [Data Wrangling and Processing for Genomics](https://datacarpentry.org/wrangling-genomics/) | any other episode | **Episodes [2](https://datacarpentry.org/wrangling-genomics/02-quality-control/index.html), [3](https://datacarpentry.org/wrangling-genomics/03-trimming/index.html), and [5](https://datacarpentry.org/wrangling-genomics/05-automation/index.html)** can work for demos. If using **episode 2** ([Assessing Read Quality](https://datacarpentry.org/wrangling-genomics/02-quality-control/index.html)) for demo, have trainee **start from `gunzip SRR2584863_1.fastq.gz` command.**   | |
| DC | Genomics | [Introduction to Cloud Computing for Genomics](https://datacarpentry.org/cloud-genomics/) | any other episode | **Episodes [2](https://datacarpentry.org/cloud-genomics/02-logging-onto-cloud/index.html) and [3](https://datacarpentry.org/cloud-genomics/03-verifying-instance/index.html) can work for demos.** If using **episode 2**, have trainees teach the version “AWS_UNIX” using the toggle box in the “Logging onto a cloud instance” section.  | |
| DC | Genomics | [Data Analysis and Visualization in R](https://datacarpentry.org/genomics-r-intro/) | **DO NOT USE for demos.** This lesson is not yet stable. | **DO NOT USE for demos.** This lesson is not yet stable.  | |
| | | | | | | |
| DC | Social Sciences | [Data Organization in Spreadsheets for Social Scientists](https://datacarpentry.org/spreadsheets-socialsci/) | <ul><li>[Introduction](https://datacarpentry.org/spreadsheets-socialsci/00-intro/index.html)</li><li>[Formatting Data Tables in Spreadsheets](https://datacarpentry.org/spreadsheets-socialsci/01-format-data/index.html)</li><li>[Formatting problems](https://datacarpentry.org/spreadsheets-socialsci/02-common-mistakes/index.html)</li><li>[Exporting data](https://datacarpentry.org/spreadsheets-socialsci/05-exporting-data/index.html)</li></ul> | <ul><li>[Dates as Data](https://datacarpentry.org/spreadsheets-socialsci/03-dates-as-data/index.html)</li><li>[Quality Assurance](https://datacarpentry.org/spreadsheets-socialsci/04-quality-assurance/index.html)</li></ul> | Lessons listed to avoid have no live coding. |
